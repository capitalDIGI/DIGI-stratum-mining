#CREATE USER pooldb@'localhost' IDENTIFIED BY '**empty**';
#DROP DATABASE IF EXISTS pooldb;
#CREATE DATABASE pooldb;
#GRANT ALL PRIVILEGES ON pooldb.* to pooldb@'localhost';
CONNECT pooldb;
...
INSERT INTO pool_worker(account_id,username,password) VALUES (1,'worker1','pass1');
